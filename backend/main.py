...
# Your precise, optimized system instructions (loaded from external file)
_SYSTEM_INSTRUCTIONS_PATH = os.path.join(os.path.dirname(__file__), "system_instructions.md")
with open(_SYSTEM_INSTRUCTIONS_PATH, encoding="utf-8") as _f:
